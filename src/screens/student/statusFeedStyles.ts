...
export const statusFeedStyles = StyleSheet.create({
  ...
  meBadgeText: { color: COLORS.textOnPrimary, fontSize: 11, fontWeight: '900' },
  postName: { color: COLORS.textPrimary, fontSize: 15, fontWeight: '900' },
  postMessage: { marginTop: 10, color: COLORS.textPrimary, fontSize: 15, lineHeight: 22, fontWeight: '700' },
