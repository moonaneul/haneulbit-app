...
export const teacherMindTalkStyles = StyleSheet.create({
  ...
  lastMessage: { fontFamily: Fonts.sans, marginTop: 4, color: COLORS.textSecondary, fontSize: 13, fontWeight: '600' },
  threadTime: { fontFamily: Fonts.sans, color: COLORS.textSecondary, fontSize: 11, fontWeight: '700' },
  ...
  threadHeaderName: { fontFamily: Fonts.sans, color: COLORS.textPrimary, fontSize: 19, fontWeight: '900' },
  ...
  voiceIcon: { fontFamily: Fonts.sans, fontSize: 20 },
